    ...
    <Box style={styles.dataFormBox}>
      ...
      <CreateAccountButton 
        onPress={async ()=> {
            ...
            if(!isPhoneExists && isValidName && isValidSurname && isValidPhone && isValidVoivodeship && isValidDriverLicense && 
              isValidCardid && isValidPassword && isValidRepeatedPassword && isPasswordSecure && !isAgreementNotChecked 
              && props.isDriver) {
              const dataObject = {
                name: name,
                surname: surname,
            ...
            else if(!isPhoneExists && isValidName && isValidSurname && isValidPhone && isValidVoivodeship && 
              isValidPassword && isValidRepeatedPassword && isPasswordSecure 
              && !isAgreementNotChecked && !props.isDriver) {
              const dataObject = {
                name: name,
                surname: surname,
                phone: phoneNumber,
      ...
      />
      <Text style={styles.creatingNewAccountText}>Tworząc nowe konto będą obowiązywać Cię</Text>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <RadioLabel style={styles.agreementText}>Wyrażam zgodę na otrzymywanie na podany numer połączeń telefonicznych 
...
const TermAndConditionsButton = (props: {
  navigation: any;
}) => {
  return (
...
function validateVoivodeship(voivodeship: string) {
  let voivodeships: string[] = ['dolnośląskie', 'kujawsko-pomorskie', 'lubelskie', 'lubuskie', 'łódzkie', 'małopolskie', 
