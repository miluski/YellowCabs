...
import { Button, Input, InputField, InputSlot, ScrollView, Text, View, ButtonText } from "@gluestack-ui/themed";
    ...
    return (
        isRideStarted ? (
            <View style={styles.bottomOptionsMainView}>  
                ...
                <Text style={styles.driverIsOnRouteText}>Kierowca już jest w drodze.</Text>
                <Text style={styles.weWillInformYouText}>Poinformujemy Cię gdy dotrze do Ciebie.</Text>
                <Text style={styles.yourRouteIsPlacedText}>Twoja trasa została zaznaczona na mapie</Text>
        ...
        >
            {props.isSelected? (
                <View style={styles.selectedTaxiTypeView}>
                    ...
                    <Text style={styles.typeText}> {props.pricePerKilometer} zł / km </Text>
                </View>
                ) : (
