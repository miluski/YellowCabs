  ...
  return (
    <Box style={{paddingHorizontal: 30}}>
      ...
      <CreateAccountButton onPress={async ()=> {
        ...
        if(!isPhoneExists && isValidName && isValidSurname && isValidPhone && isValidVoivodeship && isValidDriverLicense && isValidCardid && isValidPassword && isValidRepeatedPassword && isPasswordSecure && !isAgreementNotChecked) {
          const dataObject = {
            name: name,
            surname: surname,
